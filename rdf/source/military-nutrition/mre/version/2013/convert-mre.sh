...
sourceID="military-nutrition"               # Came from directory name ../../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
datasetID="mre"             # Came from directory name ../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
datasetVersion="2013"        # DEPRECATED
versionID="2013"             # Came from directory name ../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions) renaming datasetVersion (deprecating datasetVersion)
...
#-----------------------------------
# source/meal-ready-to-eat-ration-menus-2013.csv
sourceDir="source"
datafile="meal-ready-to-eat-ration-menus-2013.csv"
