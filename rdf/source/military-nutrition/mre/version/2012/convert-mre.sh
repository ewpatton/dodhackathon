...
datasetVersion="2012"        # DEPRECATED
versionID="2012"             # Came from directory name ../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions) renaming datasetVersion (deprecating datasetVersion)
...
#-----------------------------------
# source/meal-ready-to-eat-ration-menus-2012.csv
sourceDir="source"
datafile="meal-ready-to-eat-ration-menus-2012.csv"
