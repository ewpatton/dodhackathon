...
datasetID="fsr-menus"             # Came from directory name ../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
...
#-----------------------------------
# source/first-strike-ration-menus-2012.csv
sourceDir="source"
datafile="first-strike-ration-menus-2012.csv"
