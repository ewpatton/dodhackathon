...
datasetVersion="2008"        # DEPRECATED
versionID="2008"             # Came from directory name ../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions) renaming datasetVersion (deprecating datasetVersion)
...
#-----------------------------------
# source/first-strike-ration-menus-2008.csv
sourceDir="source"
datafile="first-strike-ration-menus-2008.csv"
